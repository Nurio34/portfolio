...
function ThemeHandler() {
  ...
  return (
    <label className="swap swap-rotate fixed z-10 top-[1vh] md:top-[2vh] right-[2vw]">
      ...
      {/* Sun icon (Light mode) */}
      <svg
        className="swap-off h-10 w-10 fill-current text-orange-300"
      ...
      {/* Moon icon (Dark mode) */}
      <svg
        className="swap-on h-10 w-10 fill-current text-yellow-300"
        style={{
          filter:
            "drop-shadow(0px 0px 10px yellow) drop-shadow(0px 0px 15px yellow) drop-shadow(0px 0px 20px yellow)",
        }}
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      >
